...
public class Settings extends JFrame {
    ...
    public Settings() {
        ...
        root.add(box);
        {
            ...
            $combo.setSelectedItem(ide.editor.Settings.theme);
            $combo.addActionListener(e -> ide.editor.Settings.setTheme((String) $combo.getSelectedItem()));
            panel.add($combo);
        }
        JTextField font_editor;
        {
            ...
            }
            {
                ...
                font_editor = new JTextField(ide.editor.Settings.fontEditor);
        ...
        }
        {
            ...
            ok.addActionListener(e -> {
                ide.editor.Settings.fontEditor = font_editor.getText();
                Editor.INSTANCE.setFont(ide.editor.Settings.loadFont(font_editor.getText(), Editor.font));
                ide.editor.Settings.settings_save(this);
            });
            name.add(ok);
        }
        setVisible(false);
